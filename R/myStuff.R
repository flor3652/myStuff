...
#' @param keep The keep function was designed to work in much the same was as rm, save to keep a character vector of objects as opposed to removing them.
#' 
#' @details
...
#note that this code may not actually be usable as overall documentation of the functions. Next steps is probably to place this entire package onto GitHub
NULL